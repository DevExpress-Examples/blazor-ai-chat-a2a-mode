...
namespace DXBlazorChatA2ASample.Services;
...
public static class DxThemes
{
    ...
    public static readonly ITheme Bootstrap =
        Themes.BootstrapExternal.Clone(properties => AddBootstrapExternalTheme("bootstrap", properties));

    public static readonly ITheme BootstrapDark =
        Themes.BootstrapExternal.Clone(properties => AddBootstrapExternalTheme("bootstrap-dark", properties));
