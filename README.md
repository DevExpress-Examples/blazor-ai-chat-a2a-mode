...
- Simulate *Task* and *Researcher* agents.
    ...
    > **Note**: `ResearcherAgent` ([source code](https://github.com/a2aproject/a2a-dotnet/blob/main/samples/AgentServer/ResearcherAgent.cs)) is based on an official Microsoft sample. This agent can receive user input, run through a simulated reasoning process, and return structured responses.
